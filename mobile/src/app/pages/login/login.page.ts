...
import {
  IonContent, IonItem, IonLabel, IonInput, IonButton, IonIcon, IonSpinner, IonText
...
@Component({
  selector: 'app-login',
  standalone: true,
  imports: [CommonModule, FormsModule, IonContent, IonItem, IonLabel, IonInput, IonButton, IonIcon, IonSpinner, IonText],
  template: `
        ...
        <div class="form-card">
          <ion-item>
            <ion-input label="Email" labelPlacement="floating" type="email"
                       [(ngModel)]="email" placeholder="votre@email.com"></ion-input>
          </ion-item>
  ...
  styles: [`
    ...
    .login-container {
      ...
      justify-content: center; min-height: 100%; padding: 20px;
    }
    .logo { text-align: center; margin-bottom: 40px;
      h1 { color: #f39c12; font-size: 1.8rem; margin: 0; }
      p { color: rgba(255,255,255,0.7); margin-top: 8px; }
    }
    .form-card {
      width: 100%; max-width: 400px; background: white;
      border-radius: 16px; padding: 30px; box-shadow: 0 10px 40px rgba(0,0,0,0.3);
      ion-item { --background: transparent; margin-bottom: 10px; }
    }
