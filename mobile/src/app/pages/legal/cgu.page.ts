  ...
  template: `
    ...
    <ion-content class="ion-padding">
      <div class="legal-content">
        ...
        <p>L'application est accessible aux employés et administrateurs d'Innov'Events disposant d'identifiants de connexion valides. L'accès est personnel et non cessible. L'utilisateur est responsable de la confidentialité de ses identifiants.</p>
        ...
        <p>Innov'Events se réserve le droit de modifier les présentes CGU à tout moment. Les utilisateurs seront informés de toute modification substantielle. La poursuite de l'utilisation de l'application vaut acceptation des nouvelles conditions.</p>
